...
(function attachTabHarborI18n(globalScope) {
  ...
  const i18nMessages = {
    en: {
      ...
      toastShortcutIconSelected: 'Shortcut icon selected',
      ...
      shortcutIconSearchLoading: 'Searching website icons...',
      shortcutIconSearchEmpty: 'No usable icons found for this website.',
      shortcutIconSearchError: 'Could not search icons for this website.',
      shortcutIconSearchNeedsUrl: 'Enter a valid URL before searching icons.',
      ...
      todoEmptyState: 'No tasks yet. Capture the next step when something needs a follow-up.',
      savedItemsCountSingular: '{count} item',
      savedItemsCountPlural: '{count} items',
    ...
    'zh-CN': {
      ...
      toastShortcutIconSelected: '已选择快捷图标',
      ...
      shortcutIconSearchLoading: '正在搜索网站图标...',
      shortcutIconSearchEmpty: '没有找到可用的网站图标。',
      shortcutIconSearchError: '无法搜索这个网站的图标。',
      shortcutIconSearchNeedsUrl: '请先输入有效 URL，再搜索图标。',
      ...
      openSavedForLater: '打开稍后阅读',
      closeSavedForLater: '关闭稍后阅读',
      savedForLater: '稍后阅读',
      openTodos: '打开待办',
      closeTodos: '关闭待办',
      todoEmptyState: '还没有任务。需要后续跟进时，把下一步记在这里。',
      savedItemsCountSingular: '{count} 项',
      savedItemsCountPlural: '{count} 项',
      shortcutsLabel: '快捷方式',
